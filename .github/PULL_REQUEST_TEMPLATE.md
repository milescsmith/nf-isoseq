...
- [ ] If necessary, also make a PR on the [nf-core/isoseq branch on the nf-core/test-datasets repo](https://github.com/nf-core/test-datasets/pull/new/nf-core/isoseq)
